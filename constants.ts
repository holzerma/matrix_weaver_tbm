...
export const initialEmployees: Employee[] = [
    { id: 'emp1', name: 'Alice Johnson', role: 'Software Engineer', salary: 90000, competenceId: 'comp1', valueStreamIds: ['vs_biz_pm_1'], functionalTeamIds: ['ft_1'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill1', proficiency: 4 }, { skillId: 'skill4', proficiency: 3 }, { skillId: 'skill23', proficiency: 4 }] },
    { id: 'emp2', name: 'Bob Williams', role: 'Product Manager', salary: 110000, competenceId: 'comp2', valueStreamIds: ['vs_biz_pm_1', 'vs_biz_pm_2'], functionalTeamIds: ['ft_1'], employeeType: 'internal', isLineManager: false, isFunctionalManager: true, isSupportRole: false, skills: [{ skillId: 'skill10', proficiency: 5 }, { skillId: 'skill12', proficiency: 4 }, { skillId: 'skill33', proficiency: 3 }] },
    { id: 'emp3', name: 'Charlie Brown', role: 'UX Designer', salary: 85000, competenceId: 'comp3', valueStreamIds: ['vs_biz_pm_1'], functionalTeamIds: ['ft_1'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill7', proficiency: 5 }, { skillId: 'skill9', proficiency: 4 }] },
    { id: 'emp4', name: 'Diana Miller', role: 'QA Engineer', salary: 75000, competenceId: 'comp1', valueStreamIds: ['vs_del_dev_4'], functionalTeamIds: ['ft_1'], employeeType: 'external', isLineManager: false, isFunctionalManager: false, isSupportRole: true, skills: [{ skillId: 'skill1', proficiency: 2 }, { skillId: 'skill10', proficiency: 3 }] },
    { id: 'emp5', name: 'Ethan Davis', role: 'DevOps Engineer', salary: 105000, competenceId: 'comp4', valueStreamIds: ['vs_inf_cmp_4', 'vs_del_sp_1'], functionalTeamIds: ['ft_2'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill13', proficiency: 4 }, { skillId: 'skill14', proficiency: 5 }, { skillId: 'skill15', proficiency: 3 }, { skillId: 'skill26', proficiency: 4 }] },
    { id: 'emp6', name: 'Fiona Garcia', role: 'Senior Consultant', salary: 140000, competenceId: 'comp2', valueStreamIds: ['vs_del_sp_3'], functionalTeamIds: [], employeeType: 'external', isLineManager: false, isFunctionalManager: true, isSupportRole: false, skills: [{ skillId: 'skill12', proficiency: 5 }] },
    { id: 'emp7', name: 'George Harris', role: 'Backend Engineer', salary: 95000, competenceId: 'comp5', valueStreamIds: ['vs_biz_pm_2'], functionalTeamIds: ['ft_3'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill5', proficiency: 4 }, { skillId: 'skill6', proficiency: 3 }, { skillId: 'skill24', proficiency: 2 }] },
    { id: 'emp8', name: 'Hannah Clark', role: 'Data Scientist', salary: 120000, competenceId: 'comp6', valueStreamIds: ['vs_ai_prd_1'], functionalTeamIds: ['ft_4'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill16', proficiency: 5 }, { skillId: 'skill17', proficiency: 3 }, { skillId: 'skill29', proficiency: 4 }] },
    { id: 'emp9', name: 'Ian Wright', role: 'Senior Backend Engineer', salary: 125000, competenceId: 'comp5', valueStreamIds: ['vs_inf_cmp_2', 'vs_del_dev_2'], functionalTeamIds: ['ft_3'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill24', proficiency: 5 }, { skillId: 'skill4', proficiency: 3 }, { skillId: 'skill6', proficiency: 2 }] },
    { id: 'emp10', name: 'Jane Doe', role: 'Security Analyst', salary: 98000, competenceId: 'comp9', valueStreamIds: ['vs_sc_fin_1'], functionalTeamIds: [], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: true, skills: [{ skillId: 'skill31', proficiency: 4 }, { skillId: 'skill32', proficiency: 3 }] },
    { id: 'emp11', name: 'Kevin Moore', role: 'Cloud Architect', salary: 150000, competenceId: 'comp4', valueStreamIds: ['vs_del_sp_1'], functionalTeamIds: ['ft_2'], employeeType: 'internal', isLineManager: false, isFunctionalManager: true, isSupportRole: false, skills: [{ skillId: 'skill13', proficiency: 5 }, { skillId: 'skill28', proficiency: 4 }, { skillId: 'skill15', proficiency: 4 }] },
    { id: 'emp12', name: 'Laura Taylor', role: 'Frontend Developer', salary: 88000, competenceId: 'comp1', valueStreamIds: ['vs_wkp_cc_4'], functionalTeamIds: [], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill2', proficiency: 4 }, { skillId: 'skill23', proficiency: 3 }] },
    { id: 'emp13', name: 'Michael Scott', role: 'Engineering Manager', salary: 160000, competenceId: 'comp5', valueStreamIds: [], functionalTeamIds: ['ft_2', 'ft_3'], employeeType: 'internal', isLineManager: true, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill10', proficiency: 5 }, { skillId: 'skill22', proficiency: 4 }] },
    { id: 'emp14', name: 'Nancy Green', role: 'Scrum Master', salary: 92000, competenceId: 'comp2', valueStreamIds: ['vs_biz_pm_1', 'vs_biz_pm_2'], functionalTeamIds: ['ft_1', 'ft_4'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: true, skills: [{ skillId: 'skill10', proficiency: 5 }, { skillId: 'skill11', proficiency: 5 }] },
    { id: 'emp15', name: 'Oliver King', role: 'Data Analyst', salary: 78000, competenceId: 'comp6', valueStreamIds: ['vs_sc_fin_1'], functionalTeamIds: [], employeeType: 'external', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill16', proficiency: 4 }, { skillId: 'skill30', proficiency: 4 }] },
    { id: 'emp16', name: 'Penelope Hill', role: 'UI Designer', salary: 82000, competenceId: 'comp3', valueStreamIds: ['vs_wkp_cc_4'], functionalTeamIds: [], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill7', proficiency: 4 }, { skillId: 'skill8', proficiency: 3 }] },
    { id: 'emp17', name: 'Quincy Adams', role: 'Site Reliability Engineer', salary: 115000, competenceId: 'comp4', valueStreamIds: ['vs_inf_cmp_1'], functionalTeamIds: ['ft_2'], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill15', proficiency: 4 }, { skillId: 'skill27', proficiency: 4 }, { skillId: 'skill5', proficiency: 3 }] },
    { id: 'emp18', name: 'Rachel Zane', role: 'Marketing Specialist', salary: 72000, competenceId: 'comp7', valueStreamIds: ['vs_biz_pm_2'], functionalTeamIds: [], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill19', proficiency: 4 }, { skillId: 'skill20', proficiency: 3 }] },
    { id: 'emp19', name: 'Steve Rogers', role: 'Sales Executive', salary: 100000, competenceId: 'comp8', valueStreamIds: ['vs_biz_pm_2'], functionalTeamIds: [], employeeType: 'internal', isLineManager: false, isFunctionalManager: false, isSupportRole: false, skills: [{ skillId: 'skill21', proficiency: 5 }, { skillId: 'skill22', proficiency: 5 }] },
    { id: 'emp20', name: 'Tony Stark', role: 'Principal Engineer', salary: 180000, competenceId: 'comp5', valueStreamIds: ['vs_ai_gen_1'], functionalTeamIds: ['ft_4'], employeeType: 'internal', isLineManager: false, isFunctionalManager: true, isSupportRole: false, skills: [{ skillId: 'skill5', proficiency: 5 }, { skillId: 'skill17', proficiency: 5 }, { skillId: 'skill25', proficiency: 4 }] },
];
